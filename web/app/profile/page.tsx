            ...
            <div className="text-center py-8">
              ...
              <div className="space-y-4">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-xl transition shadow-lg"
                >
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        {stats && (
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-lg text-center">
              <p className="text-3xl font-bold text-slate-700">{unlockedCount}</p>
