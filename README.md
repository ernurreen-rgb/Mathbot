...
- `/export` - Экспорт данных пользователей
- `/exporttasks` - Экспорт задач (для бэкапа)

## ⚠️ Важно: Сохранение данных на Render

При использовании бесплатного тарифа Render, **данные (задачи, изображения) теряются при каждом обновлении кода!**

Для решения этой проблемы:
1. Используйте команду `/exporttasks` для резервного копирования перед деплоем
2. Или перейдите на платный тариф с Render Disk
3. Или используйте внешнюю базу данных (PostgreSQL)

📖 Подробнее см. [DEPLOYMENT_RU.md](./DEPLOYMENT_RU.md#-важно-почему-задачи-пропадают-при-обновлении)
