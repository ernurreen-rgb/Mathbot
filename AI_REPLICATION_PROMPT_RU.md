# Промт для генерации копии Mathbot

## Как использовать
1. Скопируйте текст из блока «Готовый промт» целиком и передайте его другому ИИ (например, в System или Developer prompt).
...
Общее требование:
- Создай полноценный репозиторий с двумя сервисами: Python бот/API и Next.js веб-приложение. Добавь README и вспомогательные инструкции (DEPLOYMENT.md, DEPLOYMENT_RU.md, QUICKSTART.md) и MIT License.
...
- Лиговая система как в Duolingo: 5 лиг (Қола, Күміс, Алтын, Платина, Алмас), мини-группы 30–50 пользователей, еженедельные сбросы; топ 7 повышается, последние 5 понижаются.
...
Результат:
- Полный репозиторий с рабочим кодом, указанной структурой, документацией и MIT License. Код должен быть самодостаточным без placeholder-файлов.
```
